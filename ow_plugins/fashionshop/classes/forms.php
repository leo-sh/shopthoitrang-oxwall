...
class FASHIONSHOP_CLASS_Forms extends Form
{
    public function __construct( $name ) 
    {
        ...
        $textField->setLabel($language->text("fashionshop", "forms_text_field_label"));
        $textField->setDescription($language->text("fashionshop", "forms_text_field_description"));
        ...
        $textareaField->setLabel($language->text("fashionshop", "forms_textarea_field_label"));
        $textareaField->setHasInvitation(true);
        $textareaField->setInvitation($language->text("fashionshop", "forms_textarea_field_invitation"));
        ...
        $selectField->setLabel($language->text("fashionshop", "forms_selectbox_field_label"));
        ...
        $multiChoiceField->setLabel($language->text("fashionshop", "forms_multichoice_field_label"));
        ...
        $uploadField->setLabel($language->text("fashionshop", "forms_file_field_label"));
        ...
        $submit->setLabel($language->text("fashionshop", "forms_submit_field_label"));

<?php
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "persons` (
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "products` (
    `id` INT NOT NULL COMMENT '',
    `name` VARCHAR(255) NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "fashions` (
    `id` INT NOT NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "fashion_tools` (
    `id` INT NOT NULL COMMENT '',
    `type` VARCHAR(255) NULL COMMENT '',
    `code` VARCHAR(45) NULL COMMENT '',
    PRIMARY KEY (`id`)  COMMENT '')
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "cosmetics` (
    `id` INT NOT NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "hand_make_products` (
    `id` INT NOT NULL COMMENT '',
    `type` VARCHAR(255) NULL COMMENT '',
    `code` VARCHAR(45) NULL COMMENT '',
    PRIMARY KEY (`id`)  COMMENT '')
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "product_types` (
    `id` INT NOT NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "ships` (
    `id` INT NOT NULL COMMENT '',
    `address` VARCHAR(255) NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "carts` (
    `id` INT NOT NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "guest_types` (
    `id` INT NOT NULL COMMENT '',
    `type` VARCHAR(45) NULL COMMENT '',
  ...
  CREATE TABLE IF NOT EXISTS `" . OW_DB_PREFIX . "guests` (
    `id` INT NOT NULL COMMENT '',
